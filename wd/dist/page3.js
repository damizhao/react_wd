...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContentBox = __webpack_require__(172);

	React.render(React.createElement(ContentBox, null),document.getElementById('detail'))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var ContentList = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var ProList = __webpack_require__(174);
	...
	var ContentList = React.createClass({displayName: "ContentList",
	    ...
	    render: function () {
	        ...
	        var PropertyList=property.map(function(pro){
	            return React.createElement(ProList, {pid: pro.id, pvid: pro.vid, key: pro.id})
	        })
	                ...
	                React.createElement("div", null, 
	                    React.createElement("div", {className: "content"}, 
	                        React.createElement("header", null, 
	                            React.createElement("div", {className: "detail_top"}, 
	                                React.createElement("span", {className: "banner_pic"}, 
	                                    React.createElement("img", {src: data.product_base.main_img, alt: ""})
	                                ), 
	                                React.createElement("srtong", {className: "title"}, data.product_base.name), 
	                                React.createElement("p", null, 
	                                    React.createElement("span", {className: "price"}, "¥", data.sku_list[0].price/100), 
	                                    React.createElement("span", {className: "sub_price"}, "¥", data.sku_list[0].ori_price/100)
	                                )
	                            ), 
	                            React.createElement("p", {className: "buy_btn"}, 
	                                React.createElement("a", {href: url}, "购买")
	                            )
	                        ), 
	                        React.createElement("section", {className: "list_hd"}, 
		...
		render:function(){
	        return (
	            React.createElement("tr", {key: this.props.key}, 
	                React.createElement("td", null, this.props.pid), React.createElement("td", null, this.props.pvid)
	            )
	        )
	    }
	})
