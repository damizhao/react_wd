...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContentBox = __webpack_require__(169);

	React.render(React.createElement(ContentBox, null),document.getElementById('list'))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var BarList = __webpack_require__(170);
				...
				React.createElement("div", null, 
					React.createElement("div", {className: "content"}, 
				    	React.createElement("div", {className: "bar"}, 
				    		React.createElement("span", {id: "js_price", className: "js_price act", onClick: this.handlerClick}, "价格"), React.createElement("span", {className: "js_sale"}, "销量"), React.createElement("span", null, "上架时间")
				    	), 
				    	React.createElement(BarList, {data: this.state.data})
				    )
				)
			)
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var BarDetails = __webpack_require__(171);

	var BarList = React.createClass({displayName: "BarList",
		render:function(){
			var listPro=this.props.data;
			var listProduct=listPro.map(function(pro){
				return React.createElement(BarDetails, {main_img: pro.main_img, name: pro.name, price: pro.sku_list.price, product_id: pro.product_id})
			});
			return (
				React.createElement("div", null, 
					React.createElement("div", {className: "shopList"}, 
			    		React.createElement("ul", {className: "buy_sel"}, 
				    		listProduct
			    		)	
			    	)
				)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BarDetails = React.createClass({displayName: "BarDetails",
		render:function(){
			var url="detail.html?product_id="+this.props.product_id
			return (
				React.createElement("li", {key: this.props.key}, 
					React.createElement("a", {href: url}, 
						React.createElement("img", {className: "smallimg", src: this.props.main_img, alt: ""}), 
						React.createElement("srtong", {className: "title"}, this.props.name), 
	    				React.createElement("span", {className: "money"}, "¥", this.props.price)
					)
	    		)
