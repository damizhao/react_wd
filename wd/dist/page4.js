...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuyContent = __webpack_require__(175);
	React.render(React.createElement(BuyContent, null),document.getElementById('pay'))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var BuyAddress = __webpack_require__(176);
	var BuyNews = __webpack_require__(177);

	var BuyContent = React.createClass({displayName: "BuyContent",
		getInitialState: function () {
				...
				return (
					React.createElement("div", null, 
						React.createElement("div", {className: "content"}, 
					    	React.createElement(BuyAddress, {data: this.state.data}), 
					    	React.createElement(BuyNews, {data: this.state.data})
					    )
					)
				)
			}else{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuyAddress = React.createClass({displayName: "BuyAddress",
		render:function(){
			...
			if(address==''){
				return (
					React.createElement("div", null, 
						React.createElement("div", {className: "delivery"}, 
				    		React.createElement("a", {href: url}, 
				    			React.createElement("span", {className: "deadd"}, "收获地址"), 
				    			React.createElement("span", {className: "deaddicon"}, "添加地址", React.createElement("i", {className: "icon_arrow"}))
				    		), 
				    		React.createElement("a", {href: ""}, 
				    			React.createElement("span", {className: "deadd"}, "配送方式"), 
				    			React.createElement("span", {className: "deaddicon"}, "全国(包邮)", React.createElement("i", {className: "icon_arrow"}))
				    		)
				    	)
					)
				)	
				...
				return (
					React.createElement("div", null, 
						React.createElement("div", {className: "delivery"}, 
				    		React.createElement("a", {href: url}, 
				    			React.createElement("span", {className: "deadd"}, "收获地址"), 
				    			React.createElement("span", {className: "deaddicon"}, 
				    				React.createElement("span", {className: "news"}, address.name), React.createElement("span", {className: "news"}, address.mobile), 
				    				React.createElement("span", {className: "news"}, address.address), 
				    				React.createElement("i", {className: "icon_arrow"})
				    			)
				    		), 
				    		React.createElement("a", {href: ""}, 
				    			React.createElement("span", {className: "deadd"}, "配送方式"), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuyNews = React.createClass({displayName: "BuyNews",
					...
					React.createElement("div", null, 
						React.createElement("div", {className: "delivery"}, 
				    		React.createElement("div", {className: "explain"}, 
				    			React.createElement("img", {className: "smallimg", src: data.product.main_img, alt: ""}), 
								React.createElement("srtong", {className: "title"}, data.product.name), 
								React.createElement("srtong", {className: "title titled"}, React.createElement("span", null, b2), React.createElement("span", null, b5)), 
				    			React.createElement("span", {className: "deaddicon deaddicond"}, "¥", data.order.pay_price/100)
				    		)
				    	), 
				    	React.createElement("p", {className: "paid"}, "实收金额", React.createElement("i", null, "¥", data.product.sku_list.price/100, "X", data.order.number)), 
						React.createElement("p", {className: "buy_btn"}, React.createElement("span", {onClick: this.handlerSubmit}, "去付款"))
					)
				)
			}else{
				return (
					React.createElement("div", null, 
						React.createElement("div", {className: "delivery"}, 
				    		React.createElement("div", {className: "explain"}, 
				    			React.createElement("img", {className: "smallimg", src: data.product.main_img, alt: ""}), 
								React.createElement("srtong", {className: "title"}, data.product.name), 
				    			React.createElement("srtong", {className: "title titled"}, React.createElement("span", null), React.createElement("span", null)), 
				    			React.createElement("span", {className: "deaddicon deaddicond"}, "¥", data.order.pay_price/100)
				    		)
				    	), 
				    	React.createElement("p", {className: "paid"}, "实收金额", React.createElement("i", null, "¥", data.product.sku_list.price/100, "X", data.order.number)), 
