...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContentBox = __webpack_require__(178);

	React.render(React.createElement(ContentBox, null),document.getElementById('buy'))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var BuyNewsPay = __webpack_require__(179);
	var BuyListPay = __webpack_require__(180);

	var BuyContentPay = React.createClass({displayName: "BuyContentPay",
		getInitialState: function () {
				...
				return (
					React.createElement("div", null, 
						React.createElement("div", {className: "content"}, 
					    	React.createElement(BuyNewsPay, {data: this.state.data}), 
					    	React.createElement(BuyListPay, {data: this.state.data}), 
					    	React.createElement("p", {className: "buy_btn"}, React.createElement("a", {href: " ", onClick: this.handlerSubmit}, "购买"))
					    )
					)
				)
			}else{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuyNewsPay = React.createClass({displayName: "BuyNewsPay",
		render:function(){
			var data = this.props.data;
			return (
				React.createElement("div", null, 
					React.createElement("header", null, 
			    		React.createElement("div", {className: "buy_sel", id: data.product_id}, 
			    			React.createElement("img", {className: "smallimg", src: data.product_base.main_img, alt: ""}), 
							React.createElement("srtong", {className: "title"}, data.product_base.name), 
			    			React.createElement("span", {className: "money"}, "¥", data.sku_list[0].price/100)
			    		)		
			    	)
				)
			)	
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var SkuList = __webpack_require__(181);

	var BuyListPay = React.createClass({displayName: "BuyListPay",
		...
		render:function(){
			...
			var skuInfo = sInfo.map(function(sku){
				return React.createElement(SkuList, {pname: sku.name, list: sku.list, pid: sku.id})
			})
			return (
				React.createElement("div", null, 
					React.createElement("section", {className: "list_hd buy_count"}, 
			    		React.createElement("span", null, 
				  			skuInfo, 
			    			React.createElement("ul", {className: "count"}, 
			    				React.createElement("li", {ref: "minus", onClick: this.handlerminus}, "-"), 
			    				React.createElement("li", null, React.createElement("input", {type: "text", value: "1", id: "count", readOnly: "true", ref: "count"})), 
			    				React.createElement("li", {ref: "plus", onClick: this.handlerplus}, "+")
			    			)
			    		)
			    	)
				)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var Listsku = __webpack_require__(182);
	var SkuList = React.createClass({displayName: "SkuList",
		render:function(){
			var list=this.props.list;
			var listSku = list.map(function(lis){
				return React.createElement(Listsku, {lname: lis.name, lid: lis.id})
			})
			return (
				React.createElement("div", null, 
					React.createElement("p", {className: "productHead", id: this.props.pid}, this.props.pname), 
					React.createElement("div", {className: "productCol"}, 
						listSku
					)
				)
			)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Listsku = React.createClass({displayName: "Listsku",
		getInitialState:function(){
			return {
				choce:true
			}
		...
		render:function(){
			return (
				React.createElement("span", {id: this.props.lid, onClick: this.choose}, this.props.lname)
			)
		}
	})
