...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContentBox = __webpack_require__(164);

	React.render(React.createElement(ContentBox, null),document.getElementById('app'))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var ContentList = __webpack_require__(165);
	var Hotshop = __webpack_require__(166);
			    			...
			    			React.createElement("div", null, 
								React.createElement("div", {className: "content"}, 
							    	React.createElement("header", null, 
							    		React.createElement("span", {className: "banner_pic"}, React.createElement("img", {src: "images/banner.jpg", alt: "", className: "banner_img"})), 
							    		React.createElement("span", {className: "banner_logo"}, React.createElement("img", {src: "images/logo.jpg", alt: ""})), 
							    		React.createElement("strong", {className: "banner_title"}, "游友")
							    	), 
							    	React.createElement(ContentList, null), 
							    	React.createElement(Hotshop, {data: this.state.data}), 
							    	React.createElement("footer", null, 
							    		React.createElement("a", {href: ""}, "店铺全部商品")
							    	)
							    )
							)
			    		)
				...
				React.createElement("div", null, 
					React.createElement("section", {className: "list"}, 
			    		React.createElement("ul", null, 
			    			React.createElement("li", null, React.createElement("a", {href: "list.html?group_id=400535960", id: "400535960"}, "保温杯/壶")), 
			    			React.createElement("li", null, React.createElement("a", {href: "list.html?group_id=400551754", id: "400551754"}, "美妆")), 
			    			React.createElement("li", null, React.createElement("a", {href: "list.html?group_id=400610085", id: "400610085"}, "厨房用品")), 
			    			React.createElement("li", null, React.createElement("a", {href: "list.html?group_id=400611524", id: "400611524"}, "个人护理"))
			    		)
			    	)
				)
			)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hotshop = React.createClass({displayName: "Hotshop",
		render:function(){
			var data=this.props.data;
			if(!Array.isArray(data)) throw new Error('error');
			var listComp=data.map(function(lis){
					return React.createElement(Product, {key: lis.group_name, titleMessage: lis.group_name, group_id: lis.group_id, data: lis.product_list})
			})
			return (
				React.createElement("div", null, 
					listComp
	...
	var Product = React.createClass({displayName: "Product",
		render:function(){
			...
			var proList=pro.map(function(pro){
				return React.createElement(ProductList, {key: pro.name, main_img: pro.main_img, title: pro.name, price: pro.sku_list.price, ori_price: pro.sku_list.ori_price, product_id: pro.product_id})
			})
			var url="list.html?group_id="+this.props.group_id
			return(
				React.createElement("div", null, 
					React.createElement("section", {className: "list_hd", key: this.props.key}, 
		...
		render:function(){
			...
			return (
				React.createElement("li", {key: this.props.key}, 
					React.createElement("a", {href: url}, 
						React.createElement("img", {src: this.props.main_img, alt: ""}), 
	    				React.createElement("srtong", {className: "title"}, this.props.title), 
	    				React.createElement("span", {className: "price"}, "¥", this.props.price/100), 
	    				React.createElement("span", {className: "sub_price"}, "¥", this.props.ori_price/100)
					)
	    		)
			)
		}
